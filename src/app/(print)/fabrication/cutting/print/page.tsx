// app/(print)/fabrication/cutting/print/page.tsx
...
export default async function FabricationCuttingPrintPage({
  searchParams,
}: {
  ...
  try {
    ...
    const siteAddressLine2 = ""; // keep optional, add if you ever have a second line
        ...
        <div className="print-root p-4">
          <FabricationClient
            ...
            base={{
              ...
              colourHex: typeof stagePowdercoat?.hex === "number" ? stagePowdercoat.hex : undefined,
              dateString,
            }}
