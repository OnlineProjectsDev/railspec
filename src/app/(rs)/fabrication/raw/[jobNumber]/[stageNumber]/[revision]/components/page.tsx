      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">
            Job #{job.job_number} — Stage {jobStage.stage} — Rev {resolvedRevision.revisionCode} Components Order
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Component quantities grouped by part and details for the selected revision route.
          </p>
        </div>
