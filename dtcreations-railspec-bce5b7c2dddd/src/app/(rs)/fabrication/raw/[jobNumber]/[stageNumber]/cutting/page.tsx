// /app/(rs)/fabrication/raw/[jobNumber]/[stageNumber]/cutting/page.tsx
...
import StageCuttingSheetTable, { type StageCuttingSheetRow } from "./StageCuttingSheetTable"
...
export default async function FabricationCuttingSheetPage({ params }: PageProps) {
  try {
      ...
      <div className="p-4 flex flex-col gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">
            Job #{job.job_number} — Stage {jobStage.stage} Cutting Sheet
          </h1>
          <p className="text-sm text-muted-foreground mt-1">
            Extrusions grouped per balcony by exact fabrication details, with quantity combined.
          </p>
        </div>
