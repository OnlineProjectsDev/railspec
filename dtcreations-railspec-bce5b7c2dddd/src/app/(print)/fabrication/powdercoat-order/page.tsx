// src/app/(print)/fabrication/powdercoat-order/page.tsx
...
export default async function FabricationPowdercoatPrintPage({
  searchParams,
}: {
  ...
  try {
    ...
    const clientName = customer?.company ?? [customer?.firstName, customer?.lastName].filter(Boolean).join(" ");
